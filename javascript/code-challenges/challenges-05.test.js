...
const addValues = (arr) => {
  let array = arr.reduce((first, second) => {
    return first + second;
  } , 0 ) ;
  return array;
};
...
const addPurchases = (arr) => {
  let array = arr.reduce( (first, second) => {
    return first + second.purchasePrice;
  } , 0 ) ;
  return array;
};
// SOLVED
...
const returnNames = (arr) => {
  let array = arr.reduce(( first , second , third ) => {
    first [third] = second.name ;
    return first ;
  } , [] ) ;
  return array ;
};
...
const reversedString = (str) => {
  let array = str.split('').reduce(( first , second ) => {
    first = second + first ;
    return first ;
  });
  return array ;
